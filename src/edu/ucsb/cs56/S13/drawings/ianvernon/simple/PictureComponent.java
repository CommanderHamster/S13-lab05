package edu.ucsb.cs56.S13.drawings.ianvernon.simple;
...
/**
   ...
   @author Ian Vernon (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
	   ...
	   new Circle
	   (
	    snowManCenterBottomX, snowManCenterBottomY - topRadius*7 - topRadius, topRadius
	    );	   
       g2.draw(snowManTopCircle);
       
       g2.drawString("A house and a snowman, by Phill Conrad", 20,20);
       g2.drawString("Top of snowman added by Ian Vernon", 20,40);
    }
