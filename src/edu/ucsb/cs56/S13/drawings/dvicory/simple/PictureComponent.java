package edu.ucsb.cs56.S13.drawings.dvicory.simple;
...
/**
   ...
   @author Daniel Vicory (fixed the snowmans's head)
...
public class PictureComponent extends JComponent
{
   ...
   public void paintComponent(Graphics g)
   {
      ...
      Circle snowManTopCircle =
       ...
       g2.drawString("Top of snowman added by Daniel Vicory", 20,40);
    }
