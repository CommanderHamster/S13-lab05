package edu.ucsb.cs56.S13.drawings.vinhle.simple;
...
/**
   ...
   @author Vinh Le (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
	   ...
	   ( 
	    snowManCenterBottomX,
	    snowManCenterBottomY - middleRadius *4.75 - topRadius,
	    topRadius
	     );
       ...
       g2.drawString("Top of snowman added by Vinh Le", 20,40);
    }
