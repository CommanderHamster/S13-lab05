package edu.ucsb.cs56.S13.drawings.ychang.simple;
...
/**
   ...
   @author Yun Suk Chang (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Yun Suk Chang", 20,40);
    }
