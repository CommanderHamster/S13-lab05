...
public class Sword extends GeneralPathWrapper implements Shape
{
    ...
    public Sword(double x, double y, double width, double height)
    {
        ...
        //  plot the *hard-coded* coffee sword
        ...
        topAndBottom.lineTo(500,100); // top of sword
        
        topAndBottom.moveTo(200,400);
        topAndBottom.lineTo(400,400); // bottom of sword
        ...
        wholeSword.append(topAndBottom, false);
