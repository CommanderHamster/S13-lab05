package edu.ucsb.cs56.S13.drawings.sdowell.simple;
...
/**
   ...
   @author Sam Dowell (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
	   ...
	   (
	    snowManCenterBottomX,
	    snowManCenterBottomY - bottomRadius * 2 - 
       ...
       g2.drawString("Top of snowman added by Sam Dowell", 20,40);
    }
